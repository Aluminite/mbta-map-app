...
const deleteAllFavorite = require('./routes/favoriteDeleteAll') // edit this to make it delete by id
...
app.use('/favorite', deleteAllFavorite) // edit this to make it delete by id
